...
// --- Funções de cada exercício ---
 ...
 void Exercicio1()
{
    Console.WriteLine("Realizando o exercício Numero 1...");
...
void Exercicio2()
{
    Console.WriteLine("Realizando o exercício Numero 2...");
    int time1, time2;
 ...
 void Exercicio3()
{
    Console.WriteLine("Realizando o exercício Numero 3...");
 ...
 void Exercicio4()
{
    Console.WriteLine("Realizando o exercício Numero 4...");
 ...
 void Exercicio5()
{
    Console.WriteLine("Realizando o exercício Numero 5...");
 ...
 void Exercicio6()
{
    Console.WriteLine("Realizando o exercício Numero 6...");
