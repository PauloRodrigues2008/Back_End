...
void Opcao1()
{
    Console.WriteLine("Você escolheu a Opção Numero 1.");
}

void Opcao2()
{
    Console.WriteLine("Você escolheu a Opção Numero 2.");
}

void Opcao3()
{
    Console.WriteLine("Você escolheu a Opção Numero 3.");
}

void Sair()
{
    Console.WriteLine("Você escolheu a Opção Numero 0. Saindo do programa...");
}
